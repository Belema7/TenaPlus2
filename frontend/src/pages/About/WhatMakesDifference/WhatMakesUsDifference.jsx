  ...
  return (
    <section className="py-20 lg:py-28 bg-transparent overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center gap-3 text-emerald-400 font-semibold text-sm uppercase tracking-wider mb-4">
            <Sparkles className="w-5 h-5" />
            What Sets Tena+ Apart
          </div>
          <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-6">
            Recovery, <span className="text-emerald-400">Reimagined</span>
          </h2>
        ...
        >
          <p className="text-2xl md:text-3xl font-medium text-gray-200">
            Because <span className="text-emerald-400 font-bold">you deserve more</span> than just getting by.
          </p>
          <p className="text-lg text-gray-400 mt-4">
            You deserve to <span className="text-emerald-400 font-semibold">thrive</span>.
          </p>
        </motion.div>
      </div>
    </section>
